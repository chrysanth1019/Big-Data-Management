...
<head>
    ...
    <title>パスワード変更完了 - 日本スタイルのウェブアプリケーション</title>
                    ...
                    <div class="col-md-8 col-lg-6">
                        <div class="jp-card">
                            <div class="jp-card-header">
                                <h1 class="jp-title text-center">パスワード変更完了</h1>
                            ...
                            <div class="jp-card-body text-center">
                                <div class="jp-success-icon mb-4">
                                    <i class="fas fa-check-circle"></i>
                                </div>
                                
                                <h2 class="jp-subtitle">パスワードが正常に変更されました</h2>
                                
                                <p class="jp-text mt-3 mb-4">
                                    新しいパスワードで<br>ログインすることができます。
                                </p>
                                
                                <div class="mb-4">
                                    <a href="/login.php" class="btn jp-btn jp-btn-primary">
